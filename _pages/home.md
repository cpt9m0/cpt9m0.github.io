...
<a href="{{ site.url }}{{ site.baseurl }}/research" class="chip">Cybersecurity</a>
<a href="{{ site.url }}{{ site.baseurl }}/research" class="chip">Access Control</a>
<a href="{{ site.url }}{{ site.baseurl }}/research" class="chip">System Security</a>
...
<div class="callout-title"><i class="fa-solid fa-file-lines callout-icon"></i> USENIX WOOT '25</div>
<p><strong>Making Acoustic Side-Channel Attacks on Noisy Keyboards Viable with LLM-Assisted Spectrograms' Typo Correction</strong><br>
Seyyed Ali Ayati, Jin Hyun Park, Yichen Cai, Marcus Botacin</p>
</div>
